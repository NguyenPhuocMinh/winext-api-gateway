    ...
    try {
      ...
      if (isEmpty(config) || !kongEnable) {
        ...
        if (!isEmpty(service)) {
          ...
          if (!isEmpty(data)) {
            loggerTracer.info(`Function createService has been end with data`, {
              args: {
    ...
    try {
      ...
      if (isEmpty(config) || !kongEnable) {
        ...
        if (!isEmpty(route)) {
          ...
          if (!isEmpty(data)) {
            loggerTracer.info(`Function createRouter has been end with data`, {
              args: {
                nameRoute: data.name,
                idRoute: data.id,
              },
    ...
    try {
      ...
      if (isEmpty(config) || !kongEnable) {
        ...
        if (!isEmpty(consumer)) {
          ...
          if (!isEmpty(data)) {
            loggerTracer.info(`Function createConsumer has been end with data`, {
              args: {
      ...
      loggerTracer.error(`Function createConsumer has error`, {
        args: err.message,
      });
      return Promise.reject(err);
    }
    ...
    try {
      ...
      if (isEmpty(config) || !kongEnable) {
        ...
        if (!isEmpty(plugin)) {
          ...
          if (!isEmpty(data)) {
            loggerTracer.info(`function createPlugin has been end`);
            return next();
          }
        }
      }
